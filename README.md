...
* [简单工厂模式（Simple Factory）](https://github.com/lizhewei91/go-design-pattern/tree/main/01_simple_factory)
* [工厂方法模式（Factory Method）](https://github.com/lizhewei91/go-design-pattern/tree/main/02_factory_method)
* [抽象工厂模式（Abstract Factory）](https://github.com/lizhewei91/go-design-pattern/tree/main/03_abstract_factory)
* [建造者模式（Builder）](https://github.com/lizhewei91/go-design-pattern/tree/main/04_builder)
* [单例模式（Singleton）](https://github.com/lizhewei91/go-design-pattern/tree/main/05_singleton)
* [原型模式（Prototype）](https://github.com/lizhewei91/go-design-pattern/tree/main/06_prototype)
